...
(defconst entropy/emacs-ext-elpkg-eemacs-ext-stable-build-repo-git-tag
  (format "CI/dev/%s/20250608201204"
          entropy/emacs-ext-elpkg-eemacs-ext-stable-build-repo-version)
  "")
...
download/%s/entropy-emacs-extensions_build_%s.tar.xz"
  entropy/emacs-ext-elpkg-eemacs-ext-stable-build-repo-git-tag
  entropy/emacs-ext-elpkg-eemacs-ext-stable-build-repo-version)
  "")

(defconst entropy/emacs-ext-elpkg-eemacs-ext-stable-build-repo-archive-sha256sum
  "23f68e88e3a1019508dceb21ce3ebc8bd956328d1c7061e02130467f2c2142c4"
  "")
...
(defcustom entropy/emacs-browse-url-function-for-web-preview t
  "Like `browse-url-browser-function' but used for web preview.

This customized variable existed since a browser for web
development occasion is usually different by the daily using one.
...
`entropy/emacs-browse-url-function-get-for-web-preview' to get
the actual `browse-url-browse-function' used for internal lisp
context."
  :type '(choice
          function
...
`entropy/emacs-browse-url-function-for-web-preview'."
  (let (_)
    (cond
     ...
     (t
      (user-error
       "Invalid value of `entropy/emacs-browse-url-function-for-web-preview': %s"
       entropy/emacs-browse-url-function-for-web-preview)))))
...
(defvar entropy/emacs-ide-for-them/treesit-variants
  (when entropy/emacs-ide-is-treesit-generally-adapted-p
    (eemacs/lang/func/get-recipes-modes 'treesit-modes)))

(defvar entropy/emacs-ide-for-them/classic
  (eemacs/lang/func/get-recipes-modes 'prog-modes))
...
(defun __ureadable-file-do-prompt-of-message (format &rest args)
  (or (yes-or-no-p (apply #'entropy/emacs-safety-format format args))
      (user-error "Abort!")))
