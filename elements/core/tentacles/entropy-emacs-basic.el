...
(defun entropy/emacs-basic-kill-ring-persist ()
  ...
  (let* ((file entropy/emacs-kill-ring-persist-file)
         ...
         (inhibit-read-only t)
         (top-message
          (format ";; this file is auto-generated by entropy-emacs at %s, do not edit it manually"
...
fallback to origin when restoring with fatal)."
  (interactive)
  (let* ((file entropy/emacs-kill-ring-persist-file)
         (buffer (find-file-noselect file))
         (inhibit-read-only t)
      ...
      (condition-case error
        ...
        (error
         ...
         (unless (= (buffer-size) 0)
           (warn "Read persit kill-ring fatal, fallen back to origin done!")))))))
