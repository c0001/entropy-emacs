...
(add-to-list 'load-path
             (expand-file-name "src/elisp" (file-name-directory load-file-name)))



;;; Generated autoloads from eemacs-treemacs-defs.el

(register-definition-prefixes "eemacs-treemacs-defs" '("eemacs-treemacs/"))
